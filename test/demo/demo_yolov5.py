...
class Args:
    # config
    demo= "video"
    path = r"/home/kend/Guanxin/kend/HkcTracker-master/data/videos/palace.mp4"
    # path = r"D:\kend\work\Hk_Tracker\data\dataset\test_images"
    save_result= r"/home/kend/Guanxin/kend/HkcTracker-master/visualization/vis_folder/vis_folder/demo_output"
    fps= 30
    counts = 30
    # model
    model_path = r"/home/kend/Guanxin/kend/HkcTracker-master/weights/yolov5n.pt"
    input_size = (640, 640)
